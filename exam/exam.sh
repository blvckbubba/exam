...
sudo mysql -uroot -e "CREATE USER 'soul'@'localhost' IDENTIFIED BY 'vagrant';"
sudo mysql -uroot -e "GRANT ALL PRIVILEGES ON Exam.* TO 'soul'@'localhost';"
cd /var/www/laravel
...
sudo sed -i '26 s/=root/=soul/' /var/www/laravel/.env
